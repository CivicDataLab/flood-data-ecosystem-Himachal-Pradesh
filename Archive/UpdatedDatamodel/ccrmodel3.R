...
ccr_model <-read_data(data_scaled,ni = 2,no = 1,dmus = 1, inputs = 10:11, outputs =  36)
...
write.csv(eff_combined,"efficiencies_dummy_socialvul.csv")
write.csv(j,"jenksbreaks_dummy_socialvul.csv")

ccr_model <-read_data(data_scaled,ni = 5,no = 1,dmus = 1, inputs = 12:16, outputs =  36)
...
write.csv(vul_eff_combined,"efficiencies_dummy_infravul.csv")
write.csv(vul_j,"jenksbreaks_dummy_infravul.csv")

ccr_model <-read_data(data_scaled,ni = 4,no = 1,dmus = 1, inputs = 17:20, outputs =  36)
...
write.csv(vul_eff_combined,"efficiencies_dummy_phyvul.csv")
write.csv(vul_j,"jenksbreaks_dummy_phyvul.csv")
