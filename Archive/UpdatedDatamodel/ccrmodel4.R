...
ccr_model <-read_data(data_scaled,ni = 2,no = 7,dmus = 1, inputs = 10:11, outputs =  25:31)
...
write.csv(eff_combined,"efficiencies_socialvul.csv")
write.csv(j,"jenksbreaks_socialvul.csv")

ccr_model <-read_data(data_scaled,ni = 5,no = 7,dmus = 1, inputs = 12:16, outputs =  25:31)
...
write.csv(vul_eff_combined,"efficiencies_infravul.csv")
write.csv(vul_j,"jenksbreaks_infravul.csv")

ccr_model <-read_data(data_scaled,ni = 4,no = 7,dmus = 1, inputs = 17:20, outputs =  25:31)
...
write.csv(vul_eff_combined,"efficiencies_phyvul.csv")
write.csv(vul_j,"jenksbreaks_phyvul.csv")
