...
def get_image_from_tile(BBOX,date_string):
    ...
    #print(floods_url)
    try:
        urllib.request.urlretrieve(floods_url, r"Tileslatest/"+date_string+"xx"+BBOX+".image")
        return None
    except:
        urllib.request.urlretrieve(floods_url, r"Tileslatest/" + date_string + "xx" + BBOX + ".image")
...
def create_tiffs_from_ncs(nc_path, image_name):
    ...
    var.rio.to_raster(r"latest/" + image_name + r".tif")
    tiff_file.close()


date_strings = [
                "2022_03_07_18","2022_01_07_06","2022_29_06_18","2022_28_06_18",
"2022_27_06_18", "2022_26_06_18", "2022_25_06_18","2022_24_06_18","2022_22_06_11"]
delta = 0.0439453125
...
for date_string in date_strings:
    ...
    extension = 'image'
        #os.chdir(path)
    result = glob.glob('Tileslatest/*.{}'.format(extension))
    ...
    shutil.rmtree('Tileslatest')
    os.makedirs('Tileslatest')
