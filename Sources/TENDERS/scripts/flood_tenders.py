...
for csv in csvs:
    ...
    POSITIVE_KEYWORDS = ['flood', 'landslide', 'flash flood', 'heavy rain', 'embankment', 'Drainage',' River', 'Khad', 'Silt', 'Bridge', 'Nallah', 'Nalla', 'Road', 'Culvert', 'Lake', 'Relief', 'Erosion','Silt', 'Culvert', 'Sluice', 'Dyke', 'Storm water drain','Emergency','Immediate', 'dam', 'irrigation', 'rain', 'pond', 'recharge', 'bank']
    ...
    scheme_kw = {#'ridf','sdrf','sopd','cidf','ltif',
                 'sdrf','lwss', 'ndrf', 'sdmf', 'flow irrigation scheme', 'wss', 'water supply scheme', 'r-rwbcis', 'ncap funds' }
