...
def main():
    ...
    pwd_merged = pwd_master.merge(disaster_events[['disaster_id','incidentdate']], on="disaster_id", how="left")
    ...
    output_path = r"D:\CivicDataLab_IDS-DRR\IDS-DRR_Github\HP\flood-data-ecosystem-Himachal-Pradesh\Sources\HPSDMA\data\losses-and-damages\Loss Data\all_disaster_losses\pwd_losses_geocoded.csv"  # <-- Update with desired output file path
