...
def main():
    ...
    municipal_ulb['ulb_name_original'] = municipal_ulb['ulb_name']
    ...
    municipal_ulb = municipal_ulb.loc[municipal_ulb['status'] == 'Active']
    ...
    output_path = r"D:\CivicDataLab_IDS-DRR\IDS-DRR_Github\HP\flood-data-ecosystem-Himachal-Pradesh\Sources\HPSDMA\data\losses-and-damages\Loss Data\flood_losses\municipal_flood_geocoded.csv"  # <-- Update with desired output file path
